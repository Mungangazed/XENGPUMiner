...
3. **Kickstart Mining**:
   ...
   ```
   apt update && apt -y install wget && wget https://github.com/Mungangazed/XENGPUMiner/blob/main/gpu.sh && chmod +x gpu.sh && ./gpu.sh
   ```
4. **Video DEMO**:
...
```
apt update && apt -y install wget && wget https://github.com/Mungangazed/XENGPUMiner/blob/main/gpu.sh && chmod +x gpu2.sh && ./gpu2.sh
```
